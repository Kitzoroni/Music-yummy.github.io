...
//
float heartSymbolDivX1 = DivX + DivWidth*1/2;
float heartSymbolDivY2 = DivY + DivHeight*1/2;
float heartSymbolDivX3 = DivX + DivHeight*1/4;
float heartSymbolDivY4 = DivY + DivWidth*1/4;
